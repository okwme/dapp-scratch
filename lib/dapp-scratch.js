    ...
    */
    ...
    writeWrapper () {
      return new Promise((resolve, reject) => {
        ...
        fs.mkdirSync('./dapp-scratch-wrapper/' + this.contractName)
        this.path = './dapp-scratch-wrapper/' + this.contractName + '/index.js'
      ...
      return new Promise((resolve, reject) => {
        try {
          this.abi.forEach((info) => {
            ...
            all += '    return this.' + this.projectName + '.' + info.name + '(' + typedFunctions + ')'
